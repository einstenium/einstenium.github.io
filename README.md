...
<head>
    ...
    <style>
        ...
        * {
        ...
        body::before { top: 20%; left: 20%; }
        body::after { bottom: 20%; right: 20%; }
    ...
    <div class="profile-card">
        ...
        <div class="btn-container">
            ...
            <button class="audio-btn" id="audioToggle">
                ...
                <span id="btnText">Play Audio</span>
            </button>
        </div>
    </div>

    <!-- AUDIO PLAYER (Substitua audio.mp3 pelo nome do seu arquivo de audio) -->
